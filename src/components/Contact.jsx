...
function ContactCard() {
  const contacts = [
    { label: "Email", icon: <FaEnvelope />, value: "cv-capre-rodrigo@example.com", link: "mailto:cv-capre-rodrigo@example.com" },
    { label: "GitHub", icon: <FaGithub />, value: "github.com/tu-usuario", link: "https://github.com/tu-usuario" },
    { label: "LinkedIn", icon: <FaLinkedin />, value: "linkedin.com/in/tu-usuario", link: "https://linkedin.com/in/tu-usuario" },
  ];
        ...
        <div className="flex flex-col divide-y divide-gray-200 dark:divide-gray-700">
          {contacts.map((c, idx) => (
            <a
              ...
              className="flex items-center gap-3 py-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition rounded-lg"
            >
